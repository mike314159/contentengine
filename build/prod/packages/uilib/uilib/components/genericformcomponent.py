...
class GenericFormComponent(Component):
    ...
    def __init__(
        ...
        self.header_sub_text = None
        # self.button_text = button_text
        self.footer_text_lines = []
        # #self.error_msg = None
        self.add_captcha = False
    ...
    def add_header_text(self, text, sub_text=None):
        self.header_text = text
        self.header_sub_text = sub_text
    ...
    def validate(self):
        ...
        for control in self.controls:
            #print("Validating control: ", control.name)
            control.validate()

    def is_valid(self):
        for control in self.controls:
            if not control.is_valid():
                print("Control is not valid: ", control.name)
                return False
        return True
    ...
    def render(self):
        ...
        if self.add_captcha:
            captcha_html = """
            <div class="mb-3">
                <img src='/captcha' alt='captcha' style='height: 100px;' />
            </div>
            """
        else:
            captcha_html = ""
    ...
    @classmethod
    def example(cls):
        from .formfields import FormTextField, FormPasswordField
        component = cls(css_id="example-form")
        
        # Add fields to the component
        component.add_field(FormTextField("name", "Full Name", "Enter your full name"))
        component.add_field(FormTextField("email", "Email Address", "Enter your email address"))
        component.add_field(FormPasswordField("password", "Password", "Enter your password"))
        
        # Set other properties
        component.header_text = "Sample Form"
        component.header_sub_text = "Please fill out the form below"
        component.button_text = "Submit"
        component.post_url = "/submit"
        component.cancel_url = "/cancel"
        
        return component

    # @staticmethod
    # def example(view="signup"):
    #     logo_src = None
    #     logo_alt = "Bootstrap"
    #     logo_width = "72"
    #     logo_height = "57"
